function ApplePic({ className = '' }) {
  return (
    ...
    >
      <svg
        className="absolute inset-0 w-70 h-70
      ...
      <svg
        className="absolute w-64 h-64 fill-none
      ...
      <img
        src="/apple.png"
        alt="green apple"
        className="absolute left-1/2 bottom-13 -translate-x-1/2 z-1
      ...
      <img
        src="/Ellipse 4.png"
        alt="shadow"
        className="absolute left-1/2 bottom-[calc(52px-0.5*44px)] -translate-x-1/2 w-32 h-11
